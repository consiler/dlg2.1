...
<div id="internal-wrap">
  <div id="secondary-internal-header-wrap">
    <div id="secondary-internal-header" class="centered" style="background:url(<?php the_field('page_heading_image'); ?>); background-repeat: no-repeat; background-position:right;">
      <header id="secondary-internal-header-text">
